<!-- **********************************************************************************************************************************************************
    ...
    *********************************************************************************************************************************************************** -->
    ...
    <header class="header black-bg">
          ...
          <!--logo start-->
          <a href="index.html" class="logo"><b>SomeMail</b></a>
          <!--logo end-->
          ...
          <div class="nav notify-row pull-right" id="top_menu">
              ...
              <ul class="nav top-menu">
                  ...
                  <!-- inbox dropdown end -->
                  <li>
                  <button class="btn btn-primary top-menu" type="button" data-toggle="collapse" data-target="#collapseChat" aria-expanded="false" aria-controls="collapseChat">
            Chat
                  </button>
                  </li>
              </ul>
