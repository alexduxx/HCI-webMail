        ...
        <ul class="list-group" id="contact-list">
                    <li class="list-group-item">
                        <div class="col-xs-12 col-sm-3">
                            <img src="https://www.icon2s.com/wp-content/uploads/2014/08/all-users.png" alt="Scott Stevens" class="img-responsive img-circle" />
                        </div>
                        <div class="col-xs-12 col-sm-9" href="#tab1" data-toggle="tab">
                            <h2>Group 1</h2>
                    ...
                    <li class="list-group-item ">
                        <div class="col-xs-12 col-sm-3">
                            <img src="https://www.roomsoom.com/images/testimonial-face/user%20(1).png" alt="Scott Stevens" class="img-responsive img-circle" />
                        </div>
                        <div class="col-xs-12 col-sm-9" href="#tab2" data-toggle="tab">
                            <h2>Group 2</h2>
